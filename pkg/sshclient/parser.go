...
func ParseUnmanagedONT(output string) ([]UnmanagedONT, error) {
	...
	fieldMap := []struct {
		Prefix string
		Set    func(*UnmanagedONT, string)
	}{
		{"Number              :", func(o *UnmanagedONT, v string) { o.Number = v }},
		{"F/S/P               :", func(o *UnmanagedONT, v string) { o.FSP = v }},
		{"Ont SN              :", func(o *UnmanagedONT, v string) { o.OntSN = v }},
		{"Password            :", func(o *UnmanagedONT, v string) { o.Password = v }},
		{"Loid                :", func(o *UnmanagedONT, v string) { o.Loid = v }},
		{"Checkcode           :", func(o *UnmanagedONT, v string) { o.Checkcode = v }},
		{"VendorID            :", func(o *UnmanagedONT, v string) { o.VendorID = v }},
		{"Ont Version         :", func(o *UnmanagedONT, v string) { o.OntVersion = v }},
		{"Ont SoftwareVersion :", func(o *UnmanagedONT, v string) { o.OntSoftwareVersion = v }},
		{"Ont EquipmentID     :", func(o *UnmanagedONT, v string) { o.OntEquipmentID = v }},
		{"Ont Customized Info :", func(o *UnmanagedONT, v string) { o.OntCustomizedInfo = v }},
		{"Ont autofind time   :", func(o *UnmanagedONT, v string) { o.OntAutofindTime = v }},
	}

	for _, section := range sections[1:] {
		lines := strings.Split(section, "\n")
		var ont UnmanagedONT

		for _, line := range lines {
			cleanLine := strings.TrimSpace(line)
			if cleanLine == "" || strings.Contains(cleanLine, "---- More (") {
				continue
			}
			for _, fm := range fieldMap {
				if strings.HasPrefix(cleanLine, fm.Prefix) {
					value := strings.TrimSpace(strings.TrimPrefix(cleanLine, fm.Prefix))
					fm.Set(&ont, value)
					break
				}
			}
